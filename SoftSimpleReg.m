%Code solves the finite difference time domain method 
...
%f = 230e2;
%f = 230e22;
lambda = c_c/f;     %wavelegth 

%Dimesnions of the region
xMax{1} = 20e-6;
nx{1} = 200;
ny{1} = 0.75*nx{1};
...
bc{1}.s(2).paras = {mag2,phi,omega,betap,t0,st,s,y0,sty,'s'};
